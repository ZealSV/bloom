...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <section
        id="how"
        className="relative z-10 border-b-[1.5px] border-border scroll-mt-14"
      >
        <StickyHowItWorks />
      </section>
...
function StickyHowItWorks() {
  ...
  const gardenOpacity = useTransform(
    smoothProgress,
    [0.62, 0.69, 1],
    [0, 1, 1],
  );
        ...
        <div className="hidden lg:block flex-1 sticky top-14 h-[calc(100vh-3.5rem)]">
          <div className="h-full flex items-center py-16">
            <div className="relative w-full aspect-[4/5] max-h-[580px] rounded-[3rem] bg-card border border-border/50 overflow-hidden">
              ...
              >
                <motion.div
                  style={{ opacity: topicOpacity, x: topicX }}
                  className="absolute inset-0 flex items-center justify-center p-12"
                >
                  <TopicVisual />
                </motion.div>
                <motion.div
                  style={{ opacity: chatOpacity, x: chatX }}
                  className="absolute inset-0 flex items-center justify-center p-12"
                >
                  <ChatVisual />
                </motion.div>
                <motion.div
                  style={{ opacity: gardenOpacity, x: gardenX }}
                  className="absolute inset-0 flex items-center justify-center p-12"
                >
                  <GardenVisual />
                </motion.div>
              ...
              {stage === "blooming" && (
                <g>
                  ...
                  <motion.ellipse
                    ...
                    animate={{ scale: 1 }}
                    style={{
                      transformOrigin: `${f.x}px ${groundY - 26}px`,
                      rotate: -25,
                    }}
                  />
                  <motion.ellipse
                    ...
                    animate={{ scale: 1 }}
                    style={{
                      transformOrigin: `${f.x}px ${groundY - 36}px`,
                      rotate: 25,
                    }}
                  />
                  {[0, 60, 120, 180, 240, 300].map((angle) => {
                    ...
                    const y1 = (groundY - 58 + Math.sin(radM20) * 12).toFixed(
                      3,
                    );
                    ...
                    const y3 = (groundY - 58 + Math.sin(radP20) * 12).toFixed(
                      3,
                    );
                    ...
                    return (
                      <motion.path
                        ...
                        style={{
                          transformOrigin: `${f.x}px ${groundY - 58}px`,
                        }}
                      />
                    );
                  })}
                ...
                <g>
                  ...
                  >
                    ...
                    {[0, 45, 90, 135, 180, 225, 270, 315].map((angle) => {
                      ...
                      const y1 = (groundY - 72 + Math.sin(radM22) * 18).toFixed(
                        3,
                      );
                      ...
                      const y3 = (groundY - 72 + Math.sin(radP22) * 18).toFixed(
                        3,
                      );
                      ...
                      return (
                        <motion.path
                          ...
                          style={{
                            transformOrigin: `${f.x}px ${groundY - 72}px`,
                          }}
                        />
                      );
                    })}
